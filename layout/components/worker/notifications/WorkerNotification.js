...
import { createWorkNotificationRoute } from "../../utils/notificationUtils";

const WorkerNotification = ({ notification, onRead }) => {
  ...
  const handleNotificationClick = async () => {
    ...
    const route = await createWorkNotificationRoute(notification);
    router.push(route);
  };
