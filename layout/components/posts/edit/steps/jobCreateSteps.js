          ...
          <div className="formgrid grid">
            ...
            <div className="field col">
              ...
              <CascadeSelect
                ...
                onChange={(e) => setSelectedArrangement(e.value)}
                options={livingArrangements}
                optionLabel="optName"
                optionGroupLabel="name"
                optionGroupChildren={["livingOptions"]}
        ...
        <div className="formgrid grid">
          <div className="field col">
            ...
            <Calendar
              ...
              onChange={(e) => {
                console.log("Job Start Date: ", e.target.value);
                formik.setFieldValue("jobStartDate", e.target.value);
              }}
              //   onSelect={console.log(formik.values.jobStartDate)}
              showIcon
            />
          </div>
          <div className="field col">
            ...
            <Calendar
              ...
              //   onSelect={console.log(formik.values.jobEndDate)}
              showIcon
            />
          </div>
        </div>
